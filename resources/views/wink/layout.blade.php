...
<head>
    ...
    <link href='{{ asset('wink-assets/dark.css') }}' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.13.1/build/styles/sunburst.min.css">
    @else
    <link href='{{ asset('wink-assets/light.css') }}' rel='stylesheet' type='text/css'>
...
<body class="text-text-color mb-20">
    ...
    <script src="{{ asset('wink-assets/app.js') }}"></script>
</body>
